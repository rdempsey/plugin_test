...
import random
import pluggy
from ptest import hookspecs, lib
...
def get_plugin_manager():
    pm = pluggy.PluginManager("ptest")
    pm.add_hookspecs(hookspecs)
    pm.load_setuptools_entrypoints("ptest")
    pm.register(lib)
    return pm
...
class EggsellentCook:
    ...
    def add_ingredients(self):
        results = self.hook.ptest_add_ingredients(
    ...
    def serve_the_food(self):
        condiment_comments = self.hook.ptest_prep_condiments(
